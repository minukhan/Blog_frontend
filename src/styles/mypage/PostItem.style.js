...
export const PostPlaylistDropdown = styled.div`
  display: flex;
  flex-direction: column;
  ...
  background: #ecf0f3;
  box-shadow: 0px 5px 5.8px rgba(0, 0, 0, 0.18),
    inset 0px 4px 4px rgba(255, 255, 255, 0.55);
  border-radius: 16px;
`;

export const PostPlaylistDropdownText = styled.div`
  /* 재생하기 */
...
export const PostPlaylistDropdownBar = styled.hr`
  width: 100%;
  height: 0px;
